(function (window, angular, $) {
    ...
    app.controller('Ctrl', function ($scope, CommonUtils, AlertFactory, ModalFactory, PositionService, PositionTree, EmployeeModal) {
        ...
        $scope.addEmp = function () {
            EmployeeModal.pickMultiEmployee({}, function (o) {
