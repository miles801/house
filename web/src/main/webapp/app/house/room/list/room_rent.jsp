...
<body>
<div class="main condition-row-3" ng-app="house.room.rent" ng-controller="Ctrl">
    <div class="dn">
...
<script type="text/javascript" src="<%=contextPath%>/app/house/room/list/room_rent.js"></script>
</html>