...
<body>
<div class="main condition-row-3" ng-app="house.room.star" ng-controller="Ctrl">
                    ...
                    <div class="table-responsive panel panel-table">
                        <table class="table table-striped table-hover">
                            ...
                            <tr bindonce ng-repeat="foo in beans.data" ng-cloak>
                                ...
                                <td class="text-left">
                                    <a class="btn-op blue" ng-click="cancel(foo.id);">取消关注</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<script type="text/javascript" src="<%=contextPath%>/app/house/room/list/room_star.js"></script>
</html>