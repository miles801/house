...
<body>
<div class="main" ng-app="house.customer.import" ng-controller="Ctrl">
    <div class="block">
            ...
            <div class="content-wrap">
                <form name="form" class="form-horizontal" role="form">
                    ...
                    <div class="button-row">
                        <a class="btn" ng-href="<%=contextPath%>/house/customer/template" target="_blank"
...
<script type="text/javascript" src="<%=contextPath%>/app/house/customer/list/customer_import.js"></script>
</html>
