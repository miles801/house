 ...
 */
(function (angular) {
    var app = angular.module('house.customerNews', [
        'ngResource',
        'eccrm.angular',
        'eccrm.base.param',
        'eccrm.angularstrap'
    ...
    app.service('CustomerNewsService', function (CommonUtils, $resource) {
        return $resource(CommonUtils.contextPathURL('/house/customerNews/:method'), {}, {
            // 保存
    ...
    app.service('CustomerNewsModal', function ($modal, CommonUtils, ModalFactory, AlertFactory, CustomerNewsService, ParameterLoader) {
        return {
            /**
             * options必须参数：roomId
             * @param options
            ...
            add: function (options, callback) {
                ...
                $scope.save = function () {
                    var o = {customerId: $scope.beans.customerId};
                    var name = '';
                    ...
                    CustomerNewsService.save(o, function () {
