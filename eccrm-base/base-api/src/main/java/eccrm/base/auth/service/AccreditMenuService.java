...
public interface AccreditMenuService {
     ...
     * @return 授权菜单
     */
    List<ResourceVo> queryAccreditMenus(String[] deptIds);
     ...
     * @param empId 员工ID
     */
    List<ResourceVo> queryPersonalAccreditMenus(String empId);
     ...
     */
    List<ResourceVo> queryPersonalAccreditMenusRoot(String userId);
     ...
     */
    List<ResourceVo> queryPersonalAccreditMenus(String userId, String parentId);
}
