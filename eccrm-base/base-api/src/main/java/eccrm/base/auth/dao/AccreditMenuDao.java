...
public interface AccreditMenuDao {
    ...
    List<Resource> queryMenus(String[] deptIds);
     ...
     * @param empId 员工ID
     */
    List<Resource> queryMenus(String empId);
     ...
     */
    List<Resource> queryAccreditMenuRoot(String userId);
     ...
     */
    List<Resource> queryAccreditMenus(String userId, String systemMenuId);
}
