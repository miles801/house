...
public class AccreditMenuCtrl extends BaseController {
    ...
    public void queryByDept(@RequestParam String deptId, HttpServletResponse response) {
        List<ResourceVo> menuVos = accreditMenuService.queryAccreditMenus(new String[]{deptId});
    ...
    public void queryAccreditMenu(HttpServletRequest request, HttpServletResponse response) {
        List<ResourceVo> menuVos = accreditMenuService.queryPersonalAccreditMenus((String) request.getSession().getAttribute(LoginInfo.EMPLOYEE));
        GsonUtils.printData(response, menuVos);
    }
    ...
    public void queryAccreditMenuRoot(HttpServletRequest request, HttpServletResponse response) {
        List<ResourceVo> menuVos = accreditMenuService.queryPersonalAccreditMenusRoot((String) request.getSession().getAttribute(LoginInfo.EMPLOYEE));
        GsonUtils.printData(response, menuVos);
    }
    ...
    public void queryValidAccreditMenu(@RequestParam String parentId, HttpServletRequest request, HttpServletResponse response) {
        List<ResourceVo> menuVos = accreditMenuService.queryPersonalAccreditMenus((String) request.getSession().getAttribute(LoginInfo.EMPLOYEE), parentId);
        GsonUtils.printData(response, menuVos);
    }
